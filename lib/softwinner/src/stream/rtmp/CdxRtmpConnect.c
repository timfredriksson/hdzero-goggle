...
static int aw_add_addr_info(struct sockaddr_in *service, aw_rtmp_aval_t *host, int port)
{
   ...
   /*�����ʮ�������ַ���ת��Ϊ32λ�����������ֽ����IPV4��ַ*/
    ...
    service->sin_port = htons(port);  /*�����ֽ�˳��ת��Ϊ�����ֽ�˳��*/
...
//*******************************************************************************//
//*******************************************************************************//
/*��socket buffer��n���ֽڵ�client buffer*/
...
static int SocksNegotiate(aw_rtmp_t *r)
{
    ...
    addr = htonl(service.sin_addr.s_addr);      /*��һ��32λ���������ֽ�˳��ת���������ֽ�˳��*/
...
{
    struct sockaddr_in service;  /* server��ַ*/
    ...
    if(!aw_rtmp_connect0(r, (struct sockaddr *)(&service)))  /* tcp��������� */
    {
    ...
    return aw_rtmp_connect1(r, cp);  /* rtmpӦ�ò��������� C0+C1, S0+S1+S2, C2 */
}
//************************************************************************************//
//************************************************************************************//
