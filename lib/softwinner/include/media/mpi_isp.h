...
typedef struct __ISP_MODULE_ONOFF {
	HW_S32		manual;     /*�ֶ�ģ�鿪��ʹ��(pipeline ip ����)*/
	HW_S32		afs;        /*�Զ���Ƶ���ʹ��(50Hz 60Hz)*/
	HW_S32		sharp;      /*��ʹ��*/
	HW_S32		contrast;   /*�Աȶ�ʹ��*/
	HW_S32		denoise;    /*2D����ʹ��*/
	HW_S32		drc;        /*��̬��Χѹ��ʹ��*/
	HW_S32		cem;        /*��ɫ��ǿʹ��*/
	HW_S32		lsc;        /*��ͷ��Ӱ����ʹ��*/
	HW_S32		gamma;      /*Gamma����ʹ��*/
	HW_S32		cm;         /*Color Matrixʹ��*/
	HW_S32		ae;         /*�Զ��ع�ʹ��*/
	HW_S32		af;         /*�Զ��Խ�ʹ��*/
	HW_S32		awb;        /*�Զ���ƽ��ʹ��*/
	HW_S32		hist;       /*�Զ�ֱ��ͼͳ��ʹ��*/
	HW_S32		blc;        /*�ڵ�ƽ����ʹ��*/
	HW_S32		so;         /*Sensor Offsetʹ��*/
	HW_S32		wb;         /*��ƽ�����ʹ��*/
	HW_S32		otf_dpc;    /*���㲹��ʹ��*/
	HW_S32		cfa;        /*CFA��ֵʹ��*/
	HW_S32		tdf;        /* 3dnr - 0:�ر�; 1:��*/
	HW_S32		cnr;        /*ɫ�Ƚ���ʹ��*/
	HW_S32		saturation; /*���Ͷȵ���ʹ��*/
	HW_S32		defog;      /*ȥ��ʹ��*/
	HW_S32		linearity;  /*���Խ���ʹ��*/
	HW_S32		gtm;        /*ȫ��ɫ��ӳ��ʹ��*/
	HW_S32		dig_gain;   /*��������ʹ��*/
	HW_S32		pltm;       /*�ֲ�ɫ��ӳ��ʹ��*/
	HW_S32		wdr;        /* wdr - 0:�ر�; 1:�� */
